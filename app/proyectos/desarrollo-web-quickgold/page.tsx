                    ...
                    <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
                        ...
                        <div className="max-w-5xl mx-auto md:pb-12 lg:pb-4">
                            ...
                            <div className="md:grid lg:grid-cols-12 md:grid-cols-12 md:gap-12">
                                ...
                                {/* Item 3*/}
                                <div style={{ backgroundImage: "url('/images/quickgold2.png')", backgroundPosition: "center", backgroundSize: "cover" }}  className="h-60 mt-4 max-w-xl md:max-w-none md:w-full mx-auto md:col-span-6 lg:col-span-6 md:mt-6 bg-white rounded-2xl shadow-xl" data-aos="fade-left">
                                </div>


                                {/* Item 4*/}
                                <div style={{ backgroundImage: "url('/images/quickgold3.png')", backgroundPosition: "center", backgroundSize: "cover" }}  className="h-60 mt-4 max-w-xl md:max-w-none md:w-full mx-auto md:col-span-6 lg:col-span-6 md:mt-6 bg-white rounded-2xl shadow-xl" data-aos="fade-left">
