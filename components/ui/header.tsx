        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link href="/" className={`font-medium px-5 py-3 flex items-center transition duration-150 ease-in-out ${pathname === '/' ? 'text-blue-500' : 'text-gray-600 hover:text-gray-900'}`}>Inicio</Link>
              </li>
              <li>
                <Link href="/proyectos" className={`font-medium px-5 py-3 flex items-center transition duration-150 ease-in-out ${pathname === '/proyectos' ? 'text-blue-500' : 'text-gray-600 hover:text-gray-900'}`}>Proyectos</Link>
              </li>
              <li>
