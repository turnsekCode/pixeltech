        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div style={{background: "linear-gradient(180deg,#f8f8f8,hsla(0,0%,100%,0)"}} className="relative flex flex-col items-center p-6 bg-white rounded-2xl shadow-xl h-auto lg:mt-40" data-aos="fade-left">
              <Image width={60} height={56} alt="Desarrollo web" src="/../images/campana.png" />
            ...
            <Image width={60} height={56} alt="Desarrollo web" src="/../images/developer.png" />
            ...
            <Image width={60} height={56} alt="Desarrollo web" src="/../images/seo.png" />
